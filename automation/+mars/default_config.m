...
cfg.task2.series_search_center = 850;
cfg.task2.series_search_half_span = 50;
cfg.task2.series_search_step = 5;
cfg.task2.parallel_search_center = 10;
cfg.task2.parallel_search_half_span = 5;
cfg.task2.parallel_search_step = 1;
cfg.task2.logging = {
...
cfg.task4.setpoint_block = 'Voltage Set Point';
cfg.task4.integrator_block = 'Discrete-Time Integrator';
cfg.task4.setpoint_parameter = 'Value';
cfg.task4.integrator_gain_parameter = 'gainval';
cfg.task4.integrator_ic_parameter = 'InitialCondition';
cfg.task4.target_voltage_v = 510;
cfg.task4.voltage_min = 500;
cfg.task4.voltage_max = 520;
cfg.task4.soc_min = 0;
cfg.task4.soc_max = 100;
...
cfg.task5.top_k = 5;
cfg.task5.solar_subsystem = 'Solar Array';
cfg.task5.battery_subsystem = 'Battery';
cfg.task5.solar_block = 'Solar Array';
cfg.task5.mppt_block = 'MPPT';
cfg.task5.setpoint_block = 'Voltage Set Point';
cfg.task5.integrator_block = 'Discrete-Time Integrator';
cfg.task5.battery_cell_block = 'Battery (Table-Based)';
cfg.task5.series_parameter = 'N_series';
cfg.task5.parallel_parameter = 'N_parallel';
cfg.task5.setpoint_parameter = 'Value';
cfg.task5.integrator_gain_parameter = 'gainval';
cfg.task5.integrator_ic_parameter = 'InitialCondition';
cfg.task5.state_of_charge_parameter = 'stateOfCharge';
cfg.task5.target_voltage_v = 510;
cfg.task5.voltage_min = 500;
cfg.task5.voltage_max = 520;
cfg.task5.soc_min = 0;
cfg.task5.soc_max = 100;
cfg.task5.logging = {
    'Living Quarters/PS-Simulink Converter', 'loadVoltage_V';
